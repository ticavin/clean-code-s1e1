...
var incompleteTaskHolder=document.querySelector(".incomplete-ul");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".completed-ul");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='incomplete-li task';
    ...
    editButton.className="task-btn task-btn--edit btn";

    deleteButton.className="task-btn task-btn--delete btn";
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.className='task-btn-icon';
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.classList.toggle('completed-li');
    listItem.classList.toggle('incomplete-li');
